    ...
    <section className="min-h-screen bg-white text-gray-900 dark:bg-gray-900 dark:text-white px-6 py-16 transition-colors duration-300">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg leading-relaxed">
          I'm <strong>Fatzy Faruk</strong>, a passionate frontend developer with solid knowledge in HTML, CSS, JavaScript, and React. I love building user-friendly web apps and I'm always eager to learn new things.
        </p>
